    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <span className="text-[11px] font-medium text-slate-500">Total Bazar Expenses</span>
          <div className="text-2xl font-black text-rose-700 mt-0.5">{formatTaka(stats.totalExpense)}</div>
          <span className="text-[10px] text-slate-400">{activeExpenses.length} Expense Memos</span>
        </div>

        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <span className="text-[11px] font-medium text-slate-500">Today&apos;s Bazar</span>
          <div className="text-2xl font-black text-slate-900 mt-0.5">{formatTaka(stats.todayExpense)}</div>
          <span className="text-[10px] text-slate-400">Current Day Outflow</span>
        </div>

        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
          <span className="text-[11px] font-medium text-slate-500">Remaining Cash in Hand</span>
          <div className="text-2xl font-black text-emerald-700 mt-0.5">{formatTaka(stats.currentBalance)}</div>
          <span className="text-[10px] text-emerald-600 font-bold">Liquid Cash</span>
        </div>
      </div>
