            ...
            >
              <div>
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-xs font-bold px-2 py-0.5 bg-slate-100 rounded border border-slate-200 flex-shrink-0">
              ...
              <div className="mt-3 pt-2 border-t border-slate-100 flex flex-wrap items-center justify-between gap-1 text-xs text-slate-500">
